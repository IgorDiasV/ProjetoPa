...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        SliderRz = new QSlider(groupBox_2);
        SliderRz->setObjectName(QString::fromUtf8("SliderRz"));
        SliderRz->setGeometry(QRect(39, 90, 191, 20));
        SliderRz->setOrientation(Qt::Horizontal);
        SliderRy = new QSlider(groupBox_2);
        SliderRy->setObjectName(QString::fromUtf8("SliderRy"));
        SliderRy->setGeometry(QRect(39, 60, 191, 20));
        SliderRy->setOrientation(Qt::Horizontal);
        SliderRx = new QSlider(groupBox_2);
        SliderRx->setObjectName(QString::fromUtf8("SliderRx"));
        SliderRx->setGeometry(QRect(39, 30, 191, 20));
        SliderRx->setOrientation(Qt::Horizontal);
        ...
        lcdNumberRx = new QLCDNumber(groupBox_2);
        lcdNumberRx->setObjectName(QString::fromUtf8("lcdNumberRx"));
        lcdNumberRx->setGeometry(QRect(240, 30, 64, 23));
        lcdNumberRy = new QLCDNumber(groupBox_2);
        lcdNumberRy->setObjectName(QString::fromUtf8("lcdNumberRy"));
        lcdNumberRy->setGeometry(QRect(240, 60, 64, 23));
        lcdNumberRz = new QLCDNumber(groupBox_2);
        lcdNumberRz->setObjectName(QString::fromUtf8("lcdNumberRz"));
        lcdNumberRz->setGeometry(QRect(240, 90, 64, 23));
        ...
        lcdNumberDimY->setGeometry(QRect(240, 60, 64, 23));
        ...
        lcdNumberDimZ->setGeometry(QRect(240, 90, 64, 23));
        ...
        lcdNumberDimX->setGeometry(QRect(240, 30, 64, 23));
        SliderDimZ->raise();
        label->raise();
        lcdNumberDimY->raise();
        label_7->raise();
